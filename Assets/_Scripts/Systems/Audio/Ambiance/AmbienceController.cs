...
public class AmbienceController : MonoBehaviour {
    ...
    [Header("References")]
    [SerializeField] private AmbienceBlockSetSO ambienceBlockSet;
    ...
    private void PlaySong() {
        var randomSong = GetRandomAudioClip(ambienceBlockSet.Songs);
    ...
    private void PlayChord() {
        var randomChord = GetRandomAudioClip(ambienceBlockSet.Chords);
    ...
    private AudioClip GetRandomAudioClip(List<AmbienceBlock> blocks) {
